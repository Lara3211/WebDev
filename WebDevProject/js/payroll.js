...
function viewPayslip(id) {
    ...
    if (record) {
        ...
        if (employee) {
            // Populate payslip
            const payslipContainer = payrollDetailsModal.querySelector('.modal-body');
                    ...
                    <div class="payslip">
                        <div class="payslip-header">
                            <div class="payslip-company">
                                <div class="payslip-logo">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="60" height="60">
                                        ...
                                        <text x="50" y="55" font-family="Arial" font-size="14" fill="#DAA520" text-anchor="middle">BPC</text>
                                    </svg>
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <p><strong>Pay Date:</strong> ${formatDate(record.payDate)}</p>
                            </div>
                        </div>
                        ...
                        <div class="payslip-details">
                            <div class="payslip-earnings">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><strong>${formatCurrency(record.baseSalary)}</strong></td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="payslip-deductions">
                                ...
                                <table>
                                    <tr>
                                        <td>Tax</td>
                                        <td class="text-right">${formatCurrency(record.deductions.tax)}</td>
                                    </tr>
                                    <tr>
                                        <td>SSS</td>
                                        <td class="text-right">${formatCurrency(record.deductions.sss)}</td>
                                    </tr>
                                    <tr>
                                        <td>PhilHealth</td>
                                        <td class="text-right">${formatCurrency(record.deductions.philhealth)}</td>
                                    </tr>
                                    <tr>
                                        <td>Pag-IBIG</td>
                                        <td class="text-right">${formatCurrency(record.deductions.pagibig)}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Total Deductions</strong></td>
                                        <td class="text-right"><strong>${formatCurrency(record.totalDeductions)}</strong></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="payslip-total">
                            <h3>Net Pay: ${formatCurrency(record.netSalary)}</h3>
                        </div>
                        
                        <div style="text-align: center; margin-top: 2rem;">
                            <button id="printBtn" class="btn btn-primary">
                                <svg width="18" height="18" style="vertical-align: middle; margin-right: 5px;">
